"""
DeepLabV3+ 模型训练与测试脚本
使用 ResNet50 作为编码器，在 CCPBD 数据集上进行语义分割

使用方法:
    python train_deeplabv3plus.py --data_root ./CCPBD --epochs 50 --lr 1e-4
"""
...
def main(args):
    ...
    print(f"\nCreating {DISPLAY_NAME} model with {ENCODER_NAME} encoder...")
