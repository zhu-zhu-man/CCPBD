"""
HED (Holistically-nested Edge Detection) 模型训练与测试脚本
基于 VGG16 的多尺度边缘检测网络，在 CCPBD 数据集上进行边缘检测

使用方法:
    python train_hed.py --data_root ./CCPBD --epochs 50 --lr 1e-4
"""
...
def calculate_edge_metrics(pred, target, threshold=0.5, eps=1e-7):
    """计算边缘检测指标"""
